# A2A-SIN-Teams — AGENTS.md

## Purpose

Autonomous Microsoft Teams integration agent operating within the Team Messaging ecosystem.
...
- Prefer Microsoft Teams messaging, channels, and meeting-support work.
- Do not turn this repo into a generic messaging bucket.
- Do not redefine organization docs, architecture, runtime canon, or non-Teams ownership here.
